...
Rcpp::List simulate_polymerase_cpp(int k, double ksd, int k_min, int k_max, int gene_len, double alpha, double beta, double zeta, double zeta_sd, double zeta_min, double zeta_max, int cell_num, int pol_size, int add_space, double time, int steps_to_record, Rcpp::Nullable<Rcpp::NumericVector> zeta_vec);
RcppExport SEXP _STADyUM_simulate_polymerase_cpp(SEXP kSEXP, SEXP ksdSEXP, SEXP k_minSEXP, SEXP k_maxSEXP, SEXP gene_lenSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP zetaSEXP, SEXP zeta_sdSEXP, SEXP zeta_minSEXP, SEXP zeta_maxSEXP, SEXP cell_numSEXP, SEXP pol_sizeSEXP, SEXP add_spaceSEXP, SEXP timeSEXP, SEXP steps_to_recordSEXP, SEXP zeta_vecSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(simulate_polymerase_cpp(k, ksd, k_min, k_max, gene_len, alpha, beta, zeta, zeta_sd, zeta_min, zeta_max, cell_num, pol_size, add_space, time, steps_to_record, zeta_vec));
