...
pause site estimate is denoted by betaOrg, refer to (Zhao 2023, Section 
...
human genome](simpol_figures.png){width=75%}
...
```{r simulated_lrts, fig.width=7, fig.height=5, out.width="75%"}
