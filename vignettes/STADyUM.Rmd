...
# Get the rates
chi <- getChi(srates)
beta_org <- getBetaOrg(srates)
beta_adp <- getBetaAdp(srates)
phi <- getPhi(srates)
```
...
plotPauseSitesDistribution(srates)

# Plot RNAP counts (if available)
plotRNAPCounts(srates)
```
