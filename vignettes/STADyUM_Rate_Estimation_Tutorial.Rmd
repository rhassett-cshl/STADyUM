...
1. Identify transcription start sites (TSSs) for each gene by keeping the upstream most TSS per gene from annotations
...
cd4_tsn_file <- 'lrt_test_data/PROseq-HUMAN-CD4_tsn.RDS'

# Transcript annotation file
# Contains gene models with exon structure for all genes
human_tq_file <- 'lrt_test_data/HUMAN.RDS'

# PRO-seq signal files (stranded bigWig format)
# Plus strand reads
cd4_bw_plus <- 'lrt_test_data/PROseq-HUMAN-CD4_plus.bw'
cd4_bw_minus <- 'lrt_test_data/PROseq-HUMAN-CD4_minus.bw'
